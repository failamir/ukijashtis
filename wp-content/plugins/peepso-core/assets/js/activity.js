...
PsActivity.prototype.action_nsfw = function (post_id, nsfw_status) {
	var req = { postid: post_id, nsfw_status: nsfw_status, uid: peepsodata.currentuserid };
	peepso.postJson('activity.nsfw', req, function (json) {
		if (json.success) {
			// @TODO Attempt to reload the post in-place
			window.location.reload();
		}
	});
