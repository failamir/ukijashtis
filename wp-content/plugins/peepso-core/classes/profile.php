...
//        }
    ...
    public function interactions($return = FALSE, $all = FALSE)
    {
        ...
        $aAct['member_since'] = array(
            'label' => sprintf(__('Member since %s', 'peepso-core'),date_i18n(get_option('date_format'), strtotime(get_userdata($this->user_id)->user_registered)) ),
        ...
        if(class_exists('PeepSoFriends')) {
            ...
            $aAct['friends'] = array(
                ...
                'class' => 'ps-focus__detail',
                'count' => ' ' . $PeepSoFriends->get_num_friends($this->user_id), // PeepSoViewLog::get_views($this->user_id, PeepSo::MODULE_ID),
                'order' => 501,
                'all_values' => 1,
                'is_details' => TRUE,
