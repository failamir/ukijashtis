...
class PeepSoConfigSectionBlogposts extends PeepSoConfigSectionAbstract
{
	...
	private function group_profile()
	{
        ...
        $this->args('descript', __('The profile tab will not appear if the user has no blog posts','peepso-core'));
        $this->set_field(
        ...
        $this->set_field(
            ...
            __('Enable Author Box', 'peepso-core'),
            'yesno_switch'
        );
	...
	private function group_profile_featured_images()
	{
		$this->set_field(
			...
			__('Show featured images', 'peepso-core'),
			'yesno_switch'
		);
	...
	private function group_profile_two_column()
	{
		$this->set_field(
			...
			__('Enable two column layout', 'peepso-core'),
			'yesno_switch'
		);
