...
<br/><br/>This data will help us focus our efforts better based on real world scenarios.';
    ...
    private function get_stats($desc=FALSE) {
        ...
        $stats = array(
            ...
            'prd_advancedads_desc'    => 'Advanced Ads Monetization Plugin',

            'prd_edd'           => (int) class_exists('PeepSoEDD'),
            'prd_edd_desc'    => 'EDD Monetization Plugin',

            'prd_learndash'     => (int) class_exists('PeepSoLearnDash'),
            'prd_learndash_desc'    => 'LearnDash Monetization Plugin',

            'prd_pmp'           => (int) class_exists('PeepSoPMP'),
            'prd_pmp_desc'    => 'PMP Monetization Plugin',
            ...
            'prd_wpadverts_desc'    => 'WPAdverts Monetization Plugin',
    ...
    private function run() {
        ...
        if(!PeepSo::is_api_request() && empty(PeepSo3_Mayfly::get($this->mayfly))) {
