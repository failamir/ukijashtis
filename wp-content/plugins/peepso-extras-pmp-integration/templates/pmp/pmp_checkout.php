	...
	<tbody>
		<tr>
			<td>
				...
				<div>
					<label for="bemail"><?php echo __('E-mail Address', 'pmpro');?></label>
				...
				<?php
					...
					?>
					<div>
						<label for="bconfirmemail"><?php echo __('Confirm E-mail Address', 'pmpro');?></label>
		...
		<tr>
			<td>
				...
				<?php
					...
					?>
					<div>
						<label for="bconfirmemail"><?php echo __('Confirm E-mail', 'pmpro');?></label>
						<input id="bconfirmemail" name="bconfirmemail" type="<?php echo ($pmpro_email_field_type ? 'email' : 'text'); ?>" class="input <?php echo pmpro_getClassForField("bconfirmemail");?>" size="30" value="<?php echo esc_attr($bconfirmemail)?>" />
