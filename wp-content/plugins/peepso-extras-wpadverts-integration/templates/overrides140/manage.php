        ...
        <div class="ps-classified__item ps-classified__item--manage">
            ...
            <div class="ps-classified__item-footer ps-text--muted">
                ...
                <div class="ps-classified__item-actions">
                    ...
                    <a href="<?php echo esc_attr(adverts_ajax_url()) ?>?action=adverts_delete&id=<?php echo get_the_ID() ?>&redirect_to=<?php echo __( urlencode( $baseurl ) ) ?>&_ajax_nonce=<?php echo wp_create_nonce( sprintf( 'wpadverts-delete-%d', get_the_ID() ) ) ?>" title="<?php echo __("Delete", "wpadverts") ?>" class="adverts-manage-action-delete" data-id="<?php echo get_the_ID() ?>" data-nonce="<?php echo wp_create_nonce( sprintf( 'wpadverts-delete-%d', get_the_ID() ) ) ?>">
