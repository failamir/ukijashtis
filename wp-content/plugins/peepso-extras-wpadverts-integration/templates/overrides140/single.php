...
<div class="adverts-single-box">
    <div class="adverts-single-author">
        ...
        <div class="adverts-single-author-name">
            <?php echo apply_filters( "adverts_tpl_single_posted_by", sprintf( __("by <strong>%s</strong>", "peepso-wpadverts"), get_post_meta($post_id, 'adverts_person', true) ), $post_id ) ?><br/>
            <?php printf( __('Published: %1$s (%2$s ago)', "peepso-wpadverts"), date_i18n( get_option( 'date_format' ), get_post_time( 'U', false, $post_id ) ), human_time_diff( get_post_time( 'U', false, $post_id ), current_time('timestamp') ) ) ?>
        </div>
    </div>
...
<div class="adverts-grid adverts-grid-closed-top adverts-grid-with-icons adverts-single-grid-details">
    ...
    <div class="adverts-grid-row ">
        <div class="adverts-grid-col adverts-col-30">
            ...
            <span class="adverts-row-title"><?php echo __("Category", "peepso-wpadverts") ?></span>
        </div>
        <div class="adverts-grid-col adverts-col-65">
            <?php foreach($advert_category as $c): ?> 
            <a href="<?php echo __( get_term_link( $c ) ) ?>"><?php echo join( " / ", advert_category_path( $c ) ) ?></a><br/>
            <?php endforeach; ?>
        </div>
    </div>        
    ...
    <div class="adverts-grid-row">
        <div class="adverts-grid-col adverts-col-30">
            ...
            <span class="adverts-row-title"><?php echo __("Location", "peepso-wpadverts") ?></span>
        </div>
        <div class="adverts-grid-col adverts-col-65">
