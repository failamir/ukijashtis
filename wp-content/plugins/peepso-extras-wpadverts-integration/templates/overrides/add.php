...
<div class="ps-page">
    <form action="" method="post" class="ps-form ps-form--classifieds">
            ...
            <div class="ps-form__row <?php echo "ps-form__row-" . esc_attr( str_replace("_", "-", $field["name"] )) ?> <?php if(adverts_field_has_errors($field)): ?>ps-form__row--error<?php endif; ?>">
                ...
                <div class="ps-form__field">
                    ...
                    <?php elseif($field["type"] == "adverts_field_account"): ?>
                        <div class="ps-text--formated"><?php call_user_func( adverts_field_get_renderer($field), $field) ?></div>
                    <?php else: ?>
                        <?php call_user_func( adverts_field_get_renderer($field), $field) ?>
                    <?php endif; ?>
        ...
        <div class="ps-form__footer">
            ...
            <span class="ps-right">
                <input type="submit" name="submit" value="<?php echo __("Preview", "peepso-wpadverts") ?>" class="ps-btn ps-btn-primary" />
            </span>
        </div>
    </form>
</div>
