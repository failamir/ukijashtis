			...
			<style type="text/css">
				@media screen and (min-width: 768px) {
					...
					#w2dc-controller-<?php echo $frontend_controller->hash; ?>.w2dc-listings-carousel-wrapper {
						...
						<?php else: ?>
						max-width: <?php echo (($frontend_controller->args['carousel_slide_width'] * $frontend_controller->args['carousel_show_slides']) + (20 * ($frontend_controller->args['carousel_show_slides']-1))); ?>px;
						<?php endif; ?>
					}
