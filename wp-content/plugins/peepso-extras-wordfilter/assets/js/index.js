...
const SELECTOR_MATCHER = []
	.concat(FILTER_POSTS ? ['.ps-js-activity-content', '.ps-stream-quote'] : [])
	.concat(FILTER_COMMENTS ? ['.ps-comment-item .ps-comment__content'] : [])
	.concat(FILTER_MESSAGES ? ['.ps-chat__bubble', '.ps-conversation-content'] : [])
	.join(', ');
